<div class="container-fluid py-3" id="generar-cotizacion-page">
    ...
    <div class="card-body" style="padding-top: 0;">
      ...
      <div class="row g-2 mb-1 align-items-end cot-top-row">
        ...
        <div class="col-12 col-lg-4 col-xl-3">
          ...
          <select class="form-select" id="cotCliente" style="width:100%;">
        ...
        <div class="col-12 col-sm-6 col-lg-3 col-xl-3">
          <div class="d-flex align-items-center justify-content-between mb-1 gap-2">
            ...
            <div class="cot-segmented" id="cotFacturadoSwitch">
              ...
              <button type="button" class="cot-segmented-btn" data-value="ambos">Amb</button>
            </div>
          </div>

          <div class="input-group cot-input-facturado">
            <input type="number" class="form-control" id="cotPorcentajeFacturado" min="0" max="100" step="0.01" value="0">
        ...
        <div class="col-12 col-sm-6 col-lg-2 col-xl-2">
          ...
          <div class="input-group">
            ...
            <input type="number" class="form-control" id="cotDelivery" min="0" step="0.01" value="0">
          </div>
        </div>

        <div class="col-12 col-sm-6 col-lg-2 col-xl-2">
          <label class="form-label fw-semibold mb-1">Vigencia</label>
          <input type="date" class="form-control" id="cotFechaVigencia">
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg-3 col-xl-2">
          ...
          <div class="d-flex gap-2 justify-content-lg-end cot-top-actions">
            <button type="button" class="btn btn-outline-secondary" id="btnCotLimpiar">
              <i class="bi bi-arrow-clockwise me-1"></i> Limpiar
            </button>

            <button type="button" class="btn btn-danger fw-semibold" id="btnCotGuardar">
        ...
        <div class="col-12 col-xl-4">
          <div class="card border-0 shadow-sm cot-panel-left">
            <div class="card-header bg-white border-0 pb-0">
              <h5 class="mb-0 fw-semibold">Detalle de Cotización</h5>
            </div>

            <div class="card-body pt-1 d-flex flex-column">
              <div class="cot-items-list border rounded mb-3" id="cotItemsList"></div>

              <div class="rounded p-3 mb-3 cot-summary-box">
                <div class="d-flex justify-content-between mb-2">
                  <span class="text-muted">Subtotal base</span>
                  <strong id="cotSubtotalBase">Bs 0.00</strong>
                </div>

                <div class="d-flex justify-content-between mb-2">
                  <span class="text-muted">Delivery</span>
                  <strong id="cotDeliveryView">Bs 0.00</strong>
                </div>

                <div class="d-flex justify-content-between mb-2">
                  <span class="text-muted">% Facturado</span>
                  <strong id="cotPctView">0%</strong>
                </div>

                <hr class="my-2">

                <div id="cotTotalesWrap"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-xl-8">
          <div class="card border-0 shadow-sm cot-panel-right">
              ...
              <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-column flex-md-row gap-2 w-100 w-lg-auto">
                  <div class="d-flex gap-2">
                    <input type="text" class="form-control form-control-sm" id="cotSearchNombre" placeholder="Buscar por nombre">
                    <input type="text" class="form-control form-control-sm" id="cotSearchCodigo" placeholder="Buscar por código">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-3 cot-products-body">
              <div class="cot-products-grid" id="cotProductsGrid"></div>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="modalCotErrores" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="mb-0 ps-3" id="cotErroresList"></ul>
      </div>
...
<style>
  ...
  @media (min-width: 1200px) and (max-width: 1366.98px) {
    .container-fluid#generar-cotizacion-page {
      padding-left: .55rem;
      padding-right: .55rem;
    }
